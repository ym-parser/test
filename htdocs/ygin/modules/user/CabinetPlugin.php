...
class CabinetPlugin extends PluginAbstract {
  ...
  public function activate(Plugin $plugin) {
    ...
    $menuSections = array(
      ...
      array('label' => 'Профиль', 'urlAlias' => 'cabinet/profile', 'extLink' => '/cabinet/'),
	  array('label' => 'Карточка клиента', 'urlAlias' => 'cabinet/balance', 'extLink' => '/cabinet/'),
      array('label' => 'Пользователь', 'urlAlias' => 'user', 'extLink' => '/user/'),
	  array('label' => 'Корзина', 'urlAlias' => 'search/cart', 'extLink' => '/search/'),
    );
