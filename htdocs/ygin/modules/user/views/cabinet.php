...
<div class="lk-us">
					...
					<div>
						Ваш менеджер:
						<a id="ctl00_ctl00_b_b_hlManagerName" class="linkPtr" href="#" style="padding-right:5px"><?=$model['cInfo']['manager_mail']?></a>
					</div>
			</div>
<div style="width:75%;">
<div class="lk-c1">
			<div class="gray-form cat-block">
				<span class="drop-car">
					...
					<a style="background-position:left -32px;" href="/search/cart">Корзина</a></span>
				<!--<div class="funcdesc">
			...
			<div class="gray-form cat-block">
				...
				<span class="title"><a style="background-position:left -288px" href="/cabinet/subscription">Управление подпиской</a></span>
